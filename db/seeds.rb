...
klass1 = Klass.create({user:user, name: '2a', level:2, days_per_week: 2, lessons_per_day: 3, days:'1,2'})
klass2 = Klass.create({user:user, name: '2б', level:2, days_per_week: 2, lessons_per_day: 3, days:'3,4'})

subject1 = Subject.create({user:user, name: 'Чтение', level:2, hours_per_week: 3})
subject2 = Subject.create({user:user, name: 'Рисование', level:2, hours_per_week: 2})
...
#subject6 = Subject.create({user:user, name: 'Труд', level:2, hours_per_week: 2})

teacher1 = Teacher.create({user:user, fio: 'Иванова И.И.'})
teacher2 = Teacher.create({user:user, fio: 'Петрова П.П.'})

KlassSubjectRelation.create({klass: klass1, subject:subject1, hours_per_week:3})
...
#KlassSubjectRelation.create({klass: klass1, subject:subject6, hours_per_week:2})

KlassSubjectRelation.create({klass: klass2, subject:subject1, hours_per_week:3})
KlassSubjectRelation.create({klass: klass2, subject:subject2, hours_per_week:2})
...
#KlassSubjectRelation.create({klass: klass2, subject:subject6, hours_per_week:2})
