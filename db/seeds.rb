...
#User.first.settings.create!({name:'week_days',value:'1,2'})
...
klass1 = Klass.create({user:user, name: '2a', level:2, days_per_week: 1, lessons_per_day: 4})
klass2 = Klass.create({user:user, name: '2б', level:2, days_per_week: 1, lessons_per_day: 4})
