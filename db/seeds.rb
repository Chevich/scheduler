...
klass1 = Klass.create({user:user, name: '2a', level:2})
klass2 = Klass.create({user:user, name: '2б', level:2})

subject1 = Subject.create({user:user, name: 'Чтение', level:2, hours_per_week: 2})
subject2 = Subject.create({user:user, name: 'Рисование', level:7, hours_per_week: 4})
subject3 = Subject.create({user:user, name: 'Пение', level:7, hours_per_week: 2})
subject4 = Subject.create({user:user, name: 'Письмо', level:2, hours_per_week: 2})
subject5 = Subject.create({user:user, name: 'Физкультура', level:2, hours_per_week: 2})
...
KlassSubjectRelation.create({klass: klass1, subject:subject5, hours_per_week:2})
...
KlassSubjectRelation.create({klass: klass2, subject:subject5, hours_per_week:2})
